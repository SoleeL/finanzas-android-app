...
sealed class CalculatorOperatorButtonUiEvent {
    ...
    data object Add : CalculatorOperatorButtonUiEvent()
...
//                CalculatorButtonUiState("G", false, CalculatorOperatorButtonUiEvent.Save),
            ...
            listOf(
                ...
                CalculatorButtonUiState("+", false, CalculatorOperatorButtonUiEvent.Add)
            )
        )
    )
    ...
    fun onButtonCalculatorEvent(event: CalculatorButtonUiState) {
        when (event.operator) {
            ...
            is CalculatorOperatorButtonUiEvent.Add -> addCalculatorItem()
